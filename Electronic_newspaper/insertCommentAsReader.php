 ...
 */
    ...
    if (mysqli_connect_errno($con))
    {
        ...
        $result3 = mysqli_query($con, "SELECT * FROM comment_creator WHERE ID_of_creator = ".$IDC." AND Table_Creator = 'reader'");
        if($row3 = mysqli_fetch_array($result3)){
            ...
            mysqli_query($con, "INSERT INTO `comment_creator`(`Creator_ID`, `Table_Creator`, `ID_of_creator`) VALUES (NULL, 'reader',".$IDC.")");
            $result4 = mysqli_query($con, "SELECT * FROM comment_creator WHERE ID_of_creator = ".$IDC." AND Table_Creator = 'reader'");
    ...
    mysqli_close($con);
    header("Location: Topic-Account.php?aID=".$aID."");
?>