...
<body>
    ...
    <section style="margin-left:5%;">
        ...
        <span class="one now">Tech</span>
        <span class="two"><a href="index2.php">Sports</a></span>
...
<?php 
            ...
            $result2 = mysqli_query($con, "SELECT * FROM article WHERE Article_published = 'true' AND Article_section = 'Tech'");
