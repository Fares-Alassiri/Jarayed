...
<body>
    <section class="head1">
        <span class="head">
            <span class="home-title">Jarayed</span>
    ...
    <section style="margin-left: 5%;">
        ...
        <span class="one"><a href="index.php" >Tech</a></span>
        <span class="two now">Sports</span>
        <span class="two"><a href="index3.php">Policy</a></span>
        <span class="two"><a href="index4.php">news</a></span>
    </section>
...
background-color: #f4f4f4 ;" > 
    <?php 
            ...
            $result2 = mysqli_query($con, "SELECT * FROM article WHERE Article_published = 'true' AND Article_section = 'Sports'");
            echo "<div>";
		...
		echo "</div>";
            ...
            if($ids != ""){
                header("Location: Topic-User.php?aID= ".$ids."");
            }
            mysqli_close($con);
            ?> 
