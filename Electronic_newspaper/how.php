    ...
    <body>
        ...
        <section>
            ...
            <?php 
                ...
                if ($type == "Journalist"){
                    echo '<form  action="making.php" method="POST" style="margin-top: 35px; margin-left: 38%;">';
                    echo '<input type="hidden" name="aID" value="'.$aID.'">';
                    echo '<input type="submit" name="submit" id="commentbutton" value="Edit">';
                    echo '</form>';
                }
            ?>
            <?php 
                $type = isset($_SESSION['type'])? $_SESSION['type'] : "" ;
                if ($type == "Journalist"){
                    echo '<form  action="how.php" method="POST" style="margin-top: 35px; margin-left: 38%;">';
                ...
                if($idr != ""){
                    ...
                    header("Location: JournalistAccount.php?done=1");
                }
            ?>
