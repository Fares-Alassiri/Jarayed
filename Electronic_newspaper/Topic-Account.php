<?php session_start(); if(isset($_SESSION['sign']))
        if($_SESSION['sign'] == 'false')
            header ("Location: login.php?error=you must sign first");?><html><?php
    ...
    <body>
        ...
        <section>
            ...
            <?php 
                ...
                if ($type == "reader"){
                    echo '<form  action="insertCommentAsReader.php" method="POST" style="margin-top: 35px; margin-left: 38%;">';
